 ...
 * at 2019/9/6
 * at 14:31
 * summary:每发送 onNext() 之后都会回调这个方法
 */
public class OperationDoAfterNext implements Operation {
    @Override
    ...
    public Operation createOperation() {
        ...
        integerObservable
                .doAfterNext(integer -> builder.append("doAfterNext---").append(integer).append('\n'))
